		...
		<div class="col-lg-4 col-12">
			<div class="h-100 d-flex justify-content-center flex-column">
				<div class="d-flex justify-content-end mb-2">
					@if($entry->song->bpm)
					<button data-url="{{route('metronome.get', $entry)}}" title="Abrir metronomo" class="show-metronome btn btn-secondary rounded-circle d-center mr-2" style="width: 38px; height: 38px;">@fa(['icon' => 'dot-circle', 'mr' => 0])</button>
					@endif
