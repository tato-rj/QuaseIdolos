@component('components.song.row', ['song' => $song, 'loop' => $loop, 'fullwidth' => true])
@slot('name')
...
@slot('artist')
	<a href="{{route('artists.edit', $song->artist)}}" class="link-none"><strong>{{$song->artist->name}}</strong></a>
@endslot
