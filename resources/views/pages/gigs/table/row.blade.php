	...
	<div class="row mx-auto py-3 align-items-center">
		<div class="col-lg-10 col-md-10 col-9 row">
			<div class="col-lg-3 col-md-3 col-6 text-truncate">
				<a href="{{route('gig.edit', $gig)}}" class="link-secondary fw-bold d-block" style="font-size: 1.2rem">{{$gig->name}}</a>
				<strong class="opacity-6 d-md-none">{{$gig->dateForHumans}}</strong>
			</div>
