<div class="col-lg-3 col-md-4 col-12 mb-4">
	...
	<div class="d-flex flex-column text-center">
		<button {{$gig->setlist()->exists() ? null : 'disabled'}} data-bs-toggle="modal" data-bs-target="#setlist-gig-{{$gig->id}}-modal" class="btn btn-secondary mb-2 text-truncate">@fa(['icon' => 'users'])Ver setlist</button>
		<button data-bs-toggle="modal" data-bs-target="#edit-gig-{{$gig->id}}-modal" class="btn btn-secondary mb-2 text-truncate">@fa(['icon' => 'edit'])Editar evento</button>
