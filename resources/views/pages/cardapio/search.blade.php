<form onSubmit="return false;" class="form-borderless mb-4 mx-0 w-100">
		<div class="position-relative w-100 align-items-center">
			<input data-url="{{$url}}" data-target="#{{$id}}" data-table="{{$table ?? null}}" value="{{request()->input}}" type="text" name="search" autocomplete="off" placeholder="Procure por artista, música ou estilo" class="form-control">
