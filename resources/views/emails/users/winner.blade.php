...
<h1 class="text-center text-primary text-uppercase mb-3">Parabéns {{$winner->user->first_name}}!!</h1>
...
Obrigado por participar do evento <strong>{{$winner->gig->name}}</strong> com a banda Quase Ídolos, esperamos ver você cantando com a gente de novo.
